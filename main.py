...
def draw():
    ...
    if game.state == State.MAIN_MENU:
        ...
        # draw version text
        screen.blit(game.main_menu.version_text, (screen.get_width() - game.main_menu.version_text.get_width(), screen.get_height() - game.main_menu.version_text.get_height()))
