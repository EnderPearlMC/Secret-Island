...
def draw():
    ...
    # if game state is history mode main map
        ...
        if game.hm_main_map.description_shown:
            ...
            # draw go button text
            screen.blit(game.hm_main_map.go_button_text, (game.hm_main_map.go_button_rect.x + 20, game.hm_main_map.go_button_rect.y + 5))

            for idx, val in enumerate(game.hm_main_map.descriptions):
                screen.blit(val, (int(screen.get_width() / 2 - val.get_width() / 2), int(idx * 50 + (screen.get_height() / 2.5 - val.get_height()))))
        ...
        if game.hm_main_map.locked_shown:
            screen.blit(game.hm_main_map.locked_text, (screen.get_width() / 2 - game.hm_main_map.locked_text.get_width() / 2, 0 * 50 + (screen.get_height() / 2 - game.hm_main_map.locked_text.get_height())))
            # draw close cross
            screen.blit(game.hm_main_map.cross, game.hm_main_map.cross_rect)
