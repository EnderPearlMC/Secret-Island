...
class HMHelp1Menu:
    ...
    def add_elements(self):
        ...
        self.p2 = self.font2.render("...in a forest located in Japan.", True, (238, 82, 83))
        self.p3 = self.font2.render("This forest is filled of temples...", True, (238, 82, 83))
        self.p4 = self.font2.render("...that contain many secrets.", True, (238, 82, 83))
        self.p5 = self.font2.render("Someone (you don't know) asked...", True, (238, 82, 83))
        self.p6 = self.font2.render("...you to go in those temples...", True, (238, 82, 83))
